              ...
              messages: [
                {
                  role: 'system',
                  content:
                    'Generate 3 short, genuinely useful follow-up questions for a chat UI. Base them on the conversation. Avoid generic filler. Avoid repeating the user question verbatim. Return only JSON: {"followUps":["..."]}.',
                },
                {
                  role: 'user',
